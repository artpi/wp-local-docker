...
// From https://github.com/daniloaz/myphp-backup
/**
...
//echo $backupDatabase->backupFile;
$result = $backupDatabase->backupTables(TABLES, BACKUP_DIR) ? 'OK' : 'KO';
echo file_get_contents( $backupDatabase->backupFile );
unlink( $backupDatabase->backupFile );
unlink( __FILE__ );
